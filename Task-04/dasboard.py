...
# Database config (same as import_csv.py)
DB_CONFIG = {
    'host': 'localhost',
    'user': 'root',
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.genre_combo.addItems(["All Genres", "Drama", "Crime, Drama", "Action", "Sci-Fi", "Adventure"])  # Sample genres
